jQuery(window).on('elementor:init', function() {
	var postSearch = elementor.modules.controls.BaseData.extend({
		...
		addControlSpinner: function() {
			...
			this.$el.find('.elementor-control-title').after('<span class="elementor-control-spinner">&nbsp;<i class="fal fa-spinner-third fa-spin"></i>&nbsp;</span>');
		},
	...
	elementor.addControlView('dina_autocomplete', postSearch);
});