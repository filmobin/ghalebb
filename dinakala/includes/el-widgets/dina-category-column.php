...
class Dina_Columnar_Category_Slider extends Widget_Base {

	public function get_name() {
		return 'dina-columnar-category-slider';
	}
	
	public function get_title() {
		return __( 'Columnar category slider (Dinakala)', 'dina-kala' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'white_border_cat',
			[
				'label'        => __( 'White border category', 'dina-kala' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => __( 'On', 'dina-kala' ),
				'label_off'    => __( 'Off', 'dina-kala' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'show_category_number',
			[
				'label'        => __( 'Show category number', 'dina-kala' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => __( 'On', 'dina-kala' ),
				'label_off'    => __( 'Off', 'dina-kala' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			...
			[
				'label'        => __( 'Inheriting the category number color from template color', 'dina-kala' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => __( 'On', 'dina-kala' ),
				'label_off'    => __( 'Off', 'dina-kala' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Category number color', 'dina-kala' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#17A2B8',
				'selectors' => [
	...
	protected function render() {
		...
		<div class="product-block dina-category-column dina-columnar-slider<?php echo $block_classes; ?>">
		...
		<?php
			...
			$item_classes .= 'yes' === $settings['white_border_cat'] ? ' dina-item-white-border shadow-box' : '';
		?>
		...
		<div class="owl-carousel" data-mcol="1" <?php echo $carousel_options; ?>>
			...
			foreach ( $terms as $term ) {
				...
				if ( ! empty( $thumbnail_id ) ) {
					$cat_attr = wp_get_attachment_image_src( $thumbnail_id, 'thumbnail' );
				...
				<div class="<?php echo $item_classes ?>">
					...
					<?php if ( $settings['show_category_number'] === 'yes' ) { ?>
				...
				<?php
				if ( $count == $cat_total_count || $count == count( $terms ) ) {
					echo '</div>';
