...
class Brands_Slider extends Widget_Base {
	...
	public function get_title() {
		return __( 'Brands slider (Dinakala)', 'dina-kala' );
	}
	...
	public function get_help_url() {
		return 'https://i-design.ir/docs/dinakala/?p=1035';
	}
		...
		?>
			<div class="<?php echo $block_classes ?>">
				...
				<?php
					...
					$carousel_options .= ! empty ( $settings['brcount'] ) ? ' data-itemscount="'. $settings['brcount'] .'"' : ' data-itemscount="6"';
					$carousel_options .= isset ( $settings['brcount_tablet'] ) ? ' data-itemscount-tablet="'. $settings['brcount_tablet'] .'"' : ' data-itemscount-tablet="3"';
					$carousel_options .= isset ( $settings['brcount_mobile'] ) ? ' data-itemscount-mobile="'. $settings['brcount_mobile'] .'"' : ' data-itemscount-mobile="2"';
				...
				<div class="owl-carousel logo-slider dina-brands-logo-slider"<?php echo $carousel_options; ?>>
