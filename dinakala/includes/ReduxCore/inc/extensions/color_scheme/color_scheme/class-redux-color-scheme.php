		...
		public function render() {
			...
			if ( false === $this->field['simple'] ) {
				...
				echo '          <a
                                    ...
                                    class="redux-save-scheme-button button-secondary">' . esc_html__( 'Add', 'dina-kala' ) . '
                                </a>';
				...
				echo '          <a
                                    ...
                                    class="redux-delete-scheme-button button-secondary">' . esc_html__( 'Delete', 'dina-kala' ) . '
                                </a>';
				...
				echo '          <a
                                    ...
                                    class="redux-export-scheme-button button-primary">' . esc_html__( 'Export', 'dina-kala' ) . '
                                </a>';
				...
				echo '          <a
                                    ...
                                    class="noUpdate redux-import-scheme-button button-secondary">' . esc_html__( 'Import', 'dina-kala' ) . '
                                </a>';
