				...
				<div id="redux-add-widget" class="widgets-holder-wrap">
					<div class="">
						...
						<div class="sidebar-name">
							<h3><?php echo esc_html__( 'Create Widget Area', 'dina-kala' ); ?> <span class="spinner"></span></h3>
						</div>
							...
							<form id="addWidgetAreaForm" action="" method="post">
								...
								<div class="widget-content">
									<input
											...
											class="regular-text"
											title="<?php echo esc_attr__( 'Name', 'dina-kala' ); ?>"
											placeholder="<?php echo esc_attr__( 'Name', 'dina-kala' ); ?>"/>
								</div>
								<div class="widget-control-actions">
									<div class="aligncenter">
										<input
												...
												type="submit"
												value="<?php echo esc_attr__( 'Create Widget Area', 'dina-kala' ); ?>"/>
									</div>
									<br class="clear">
								</div>
							</form>
		...
		public function enqueue() {
			...
			wp_localize_script(
				...
				array(
					...
					'confirm' => esc_html__( 'Confirm', 'dina-kala' ),
					'cancel'  => esc_html__( 'Cancel', 'dina-kala' ),
				)
			);
		}
	}
