...
class Redux_Customizer_Section extends WP_Customize_Section {
	...
	protected function render_fallback() {
		...
		<li id="accordion-section-<?php echo esc_attr( $this->id ); ?>" class="<?php echo esc_attr( $classes ); ?>">
			<h3 class="accordion-section-title" tabindex="0">
				...
				?>
				<span class="screen-reader-text"><?php esc_attr_e( 'Press return or enter to expand', 'dina-kala' ); ?></span>
			</h3>
	...
	public function json(): array {
		...
		if ( $this->panel ) {
			...
			$array['customizeAction'] = sprintf( __( 'Customizing &#9656; %s', 'dina-kala' ), esc_html( $this->manager->get_panel( $this->panel )->title ) );
		} else {
			$array['customizeAction'] = __( 'Customizing', 'dina-kala' );
		}
				...
				<li class="customize-section-description-container">
					<div class="customize-section-title">
						<button class="customize-section-back" tabindex="-1">
							<span class="screen-reader-text"><?php esc_html_e( 'Back', 'dina-kala' ); ?></span>
						</button>
						<h3>
