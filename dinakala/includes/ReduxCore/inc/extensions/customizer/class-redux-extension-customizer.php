...
if ( ! class_exists( 'Redux_Extension_Customizer', false ) ) {
	...
	class Redux_Extension_Customizer extends Redux_Extension_Abstract {
		...
		public function enqueue() {
			$localize = array(
				'save_pending'   => esc_html__( 'You have changes that are not saved.  Would you like to save them now?', 'dina-kala' ),
				'reset_confirm'  => esc_html__( 'Are you sure?  Resetting will lose all custom values.', 'dina-kala' ),
				'preset_confirm' => esc_html__( 'Your current options will be replaced with the values of this preset.  Would you like to proceed?', 'dina-kala' ),
				'opt_name'       => $this->parent->args['opt_name'],
