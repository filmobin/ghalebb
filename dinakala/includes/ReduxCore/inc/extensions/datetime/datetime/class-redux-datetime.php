...
if ( ! class_exists( 'Redux_Datetime', false ) ) {
	...
	class Redux_Datetime extends Redux_Field {
		...
		public function render() {
			...
			if ( true === $split ) {
				$date_placeholder = $this->field['placeholder']['date'] ?? esc_html__( 'Date', 'dina-kala' );
				$time_placeholder = $this->field['placeholder']['time'] ?? esc_html__( 'Time', 'dina-kala' );
			} else {
				$date_placeholder = $this->field['placeholder'] ?? esc_html__( 'Date / Time', 'dina-kala' );
			}
