...
if ( ! class_exists( 'Redux_Import_Export', false ) ) {
	...
	class Redux_Import_Export extends Redux_Field {
		...
		public function render() {
			...
			?>
			<h4><?php esc_html_e( 'Import Options', 'dina-kala' ); ?></h4>
			<p>
				<a
					href="javascript:void(0);"
					id="redux-import-code-button"
					class="button-secondary">
					<?php esc_html_e( 'Import from Clipboard', 'dina-kala' ); ?>
				</a>
				<a
					href="#"
					id="redux-import-upload"
					class="button-secondary">
					<?php esc_html_e( 'Upload file', 'dina-kala' ); ?><span></span>
				</a>
			...
			<div id="redux-import-code-wrapper">
				<p class="description" id="import-code-description">
					...
					<?php echo esc_html( apply_filters( 'redux-import-file-description', esc_html__( 'Paste your clipboard data here.', 'dina-kala' ) ) ); ?>
				</p>
			...
			<p id="redux-import-action">
				<input
					...
					value="<?php esc_html_e( 'Import', 'dina-kala' ); ?>">&nbsp;&nbsp;
				<span>
					<?php // phpcs:ignore WordPress.NamingConventions.ValidHookName ?>
					<?php echo esc_html( apply_filters( 'redux-import-warning', esc_html__( 'WARNING! This will overwrite all existing option values, please proceed with caution!', 'dina-kala' ) ) ); ?>
				</span>
			</p>
			<div class="hr">
				<div class="inner">
			...
			<h4><?php esc_html_e( 'Export Options', 'dina-kala' ); ?></h4>
			<div class="redux-section-desc">
				<p class="description">
					<?php // phpcs:ignore WordPress.NamingConventions.ValidHookName ?>
					<?php echo esc_html( apply_filters( 'redux-backup-description', esc_html__( 'Here you can copy/download your current option settings. Keep this safe as you can use it as a backup should anything go wrong, or you can use it to restore your settings on this site (or any other site).', 'dina-kala' ) ) ); ?>
				</p>
			</div>
			...
			<p>
				<button id="redux-export-code-copy" class="button-secondary"
						...
						data-copy="<?php esc_attr_e( 'Copy to Clipboard', 'dina-kala' ); ?>"
						data-copied="<?php esc_attr_e( 'Copied!', 'dina-kala' ); ?>">
					<?php esc_html_e( 'Copy to Clipboard', 'dina-kala' ); ?>
				</button>
				<a href="<?php echo esc_url( $link ); ?>" id="redux-export-code-dl" class="button-primary">
					<?php esc_html_e( 'Export File', 'dina-kala' ); ?>
				</a>
			</p>
			<p></p>
		...
		public function enqueue() {
			...
			wp_localize_script(
				...
				'ImportExport',
				array(
					'unchanged_values' => esc_html__( 'Your panel has unchanged values, would you like to save them now?', 'dina-kala' ),
				)
			);
