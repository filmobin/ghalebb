		...
		public function __construct( ReduxFramework $redux, array $args ) {
			...
			$default = array(
				...
				'font_weights'                     => array(
					array(
						'id'   => '400',
						'name' => __( 'Regular 400', 'dina-kala' ),
					),
					array(
						'id'   => '400italic',
						'name' => __( 'Regular 400 Italic', 'dina-kala' ),
					),
					array(
						'id'   => '700',
						'name' => __( 'Bold 700', 'dina-kala' ),
					),
					array(
						'id'   => '700italic',
						'name' => __( 'Bold 700 Italic', 'dina-kala' ),
					),
				),
		...
		private function no_errors_please( array $args ): array {
			...
			if ( empty( $args['footer_credit'] ) ) {
				...
				/* translators: 1: Redux, 2: Link to plugin review */
					__( 'Enjoyed %1$s? Please leave us a %2$s rating. We really appreciate your support!', 'dina-kala' ),
					'<strong>' . __( 'Redux', 'dina-kala' ) . '</strong>',
			...
			if ( empty( $args['menu_title'] ) ) {
				$args['menu_title'] = esc_html__( 'Options', 'dina-kala' );
			}

			if ( empty( $args['page_title'] ) ) {
				$args['page_title'] = esc_html__( 'Options', 'dina-kala' );
			}
