	...
	class Redux_Spacing extends Redux_Field {
		...
		public function render() {
			...
			if ( true === $this->field['all'] ) {
				...
				echo '<div class="field-spacing-input input-prepend">
                        ...
                        <input
                            ...
                            placeholder="' . esc_html__( 'All', 'dina-kala' ) . '"
				...
				if ( true === $this->field['right'] ) {
					echo '<div class="field-spacing-input input-prepend">
                            ...
                            <input type="text"
                                   ...
                                   placeholder="' . esc_html__( 'Right', 'dina-kala' ) . '"
				...
				if ( true === $this->field['left'] ) {
					echo '<div class="field-spacing-input input-prepend">
                            ...
                            <input type="text"
                                   ...
                                   placeholder="' . esc_html__( 'Left', 'dina-kala' ) . '"
			...
			if ( false !== $this->field['units'] && true === $this->field['display_units'] ) {
				echo '<div class="select_wrapper spacing-units" original-title="' . esc_html__( 'Units', 'dina-kala' ) . '">';
				echo '<select data-placeholder="' . esc_html__( 'Units', 'dina-kala' ) . '" class="redux-spacing redux-spacing-units select ' . esc_attr( $this->field['class'] ) . '" original-title="' . esc_html__( 'Units', 'dina-kala' ) . '" id="' . esc_attr( $this->field['id'] ) . '_units"' . esc_attr( $select2_data ) . '>';
