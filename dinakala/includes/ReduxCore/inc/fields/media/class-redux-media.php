	...
	class Redux_Media extends Redux_Field {
		...
		public function set_defaults() {
			...
			$defaults = array(
				...
				'url'          => true,
				'alt'          => '',
				'placeholder'  => esc_html__( 'No media selected', 'dina-kala' ),
				'readonly'     => true,
				'class'        => '',
				'filter'       => array(
					'grayscale'  => false,
		...
		public function render() {
			...
			echo '<span class="button media_upload_button" id="' . esc_attr( $this->field['id'] ) . '-media">' . esc_html__( 'Upload', 'dina-kala' ) . '</span>';
			...
			echo '<span class="button remove-image' . esc_attr( $hide ) . '" id="reset_' . esc_attr( $this->field['id'] ) . '" rel="' . esc_attr( $this->field['id'] ) . '">' . esc_html__( 'Remove', 'dina-kala' ) . '</span>';
			echo '</div>';
