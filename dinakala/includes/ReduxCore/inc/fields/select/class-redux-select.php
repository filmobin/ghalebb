	...
	class Redux_Select extends Redux_Field {
		...
		public function render() {
			...
			if ( ! empty( $this->field['options'] ) ) {
				...
				$placeholder = ( isset( $this->field['placeholder'] ) ) ? esc_attr( $this->field['placeholder'] ) : esc_html__( 'Select an item', 'dina-kala' );
				...
				echo '<strong>' . esc_html__( 'No items of this type were found.', 'dina-kala' ) . '</strong>';
			}
		}
