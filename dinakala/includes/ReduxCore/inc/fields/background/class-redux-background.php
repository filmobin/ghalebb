	...
	class Redux_Background extends Redux_Field {
		...
		public function render() {
			...
			if ( true === $this->field['background-repeat'] ) {
				$array = array(
					'no-repeat' => esc_html__( 'No Repeat', 'dina-kala' ),
					'repeat'    => esc_html__( 'Repeat All', 'dina-kala' ),
					'repeat-x'  => esc_html__( 'Repeat Horizontally', 'dina-kala' ),
					'repeat-y'  => esc_html__( 'Repeat Vertically', 'dina-kala' ),
					'inherit'   => esc_html__( 'Inherit', 'dina-kala' ),
				);

				echo '<select id="' . esc_attr( $this->field['id'] ) . '-repeat-select" data-placeholder="' . esc_html__( 'Background Repeat', 'dina-kala' ) . '" name="' . esc_attr( $this->field['name'] . $this->field['name_suffix'] ) . '[background-repeat]" class="redux-select-item redux-background-input redux-background-repeat ' . esc_attr( $this->field['class'] ) . '"' . esc_attr( $select2_data ) . '>';
				echo '<option></option>';
			...
			if ( true === $this->field['background-clip'] ) {
				$array = array(
					'inherit'     => esc_html__( 'Inherit', 'dina-kala' ),
					'border-box'  => esc_html__( 'Border Box', 'dina-kala' ),
					'content-box' => esc_html__( 'Content Box', 'dina-kala' ),
					'padding-box' => esc_html__( 'Padding Box', 'dina-kala' ),
				);

				echo '<select id="' . esc_attr( $this->field['id'] ) . '-clip-select" data-placeholder="' . esc_html__( 'Background Clip', 'dina-kala' ) . '" name="' . esc_attr( $this->field['name'] . $this->field['name_suffix'] ) . '[background-clip]" class="redux-select-item redux-background-input redux-background-clip ' . esc_attr( $this->field['class'] ) . '"' . esc_attr( $select2_data ) . '>';
				echo '<option></option>';
			...
			if ( true === $this->field['background-origin'] ) {
				...
				echo '<select id="' . esc_attr( $this->field['id'] ) . '-origin-select" data-placeholder="' . esc_html__( 'Background Origin', 'dina-kala' ) . '" name="' . esc_attr( $this->field['name'] . $this->field['name_suffix'] ) . '[background-origin]" class="redux-select-item redux-background-input redux-background-origin ' . esc_attr( $this->field['class'] ) . '"' . esc_attr( $select2_data ) . '>';
				echo '<option></option>';
			...
			if ( true === $this->field['background-size'] ) {
				$array = array(
					'inherit' => esc_html__( 'Inherit', 'dina-kala' ),
					'cover'   => esc_html__( 'Cover', 'dina-kala' ),
					'contain' => esc_html__( 'Contain', 'dina-kala' ),
				);

				echo '<select id="' . esc_attr( $this->field['id'] ) . '-size-select" data-placeholder="' . esc_html__( 'Background Size', 'dina-kala' ) . '" name="' . esc_attr( $this->field['name'] . $this->field['name_suffix'] ) . '[background-size]" class="redux-select-item redux-background-input redux-background-size ' . esc_attr( $this->field['class'] ) . '"' . esc_attr( $select2_data ) . '>';
				echo '<option></option>';
			...
			if ( true === $this->field['background-attachment'] ) {
				$array = array(
					'fixed'   => esc_html__( 'Fixed', 'dina-kala' ),
					'scroll'  => esc_html__( 'Scroll', 'dina-kala' ),
					'inherit' => esc_html__( 'Inherit', 'dina-kala' ),
				);

				echo '<select id="' . esc_attr( $this->field['id'] ) . '-attachment-select" data-placeholder="' . esc_html__( 'Background Attachment', 'dina-kala' ) . '" name="' . esc_attr( $this->field['name'] . $this->field['name_suffix'] ) . '[background-attachment]" class="redux-select-item redux-background-input redux-background-attachment ' . esc_attr( $this->field['class'] ) . '"' . esc_attr( $select2_data ) . '>';
				echo '<option></option>';
			...
			if ( true === $this->field['background-position'] ) {
				$array = array(
					'left top'      => esc_html__( 'Left Top', 'dina-kala' ),
					'left center'   => esc_html__( 'Left center', 'dina-kala' ),
					'left bottom'   => esc_html__( 'Left Bottom', 'dina-kala' ),
					'center top'    => esc_html__( 'Center Top', 'dina-kala' ),
					'center center' => esc_html__( 'Center Center', 'dina-kala' ),
					'center bottom' => esc_html__( 'Center Bottom', 'dina-kala' ),
					'right top'     => esc_html__( 'Right Top', 'dina-kala' ),
					'right center'  => esc_html__( 'Right center', 'dina-kala' ),
					'right bottom'  => esc_html__( 'Right Bottom', 'dina-kala' ),
				);

				echo '<select id="' . esc_attr( $this->field['id'] ) . '-position-select" data-placeholder="' . esc_html__( 'Background Position', 'dina-kala' ) . '" name="' . esc_attr( $this->field['name'] . $this->field['name_suffix'] ) . '[background-position]" class="redux-select-item redux-background-input redux-background-position ' . esc_attr( $this->field['class'] ) . '"' . esc_attr( $select2_data ) . '>';
				echo '<option></option>';
			...
			if ( $this->field['background-image'] ) {
				...
				$placeholder = $this->field['placeholder'] ?? esc_html__( 'No media selected', 'dina-kala' );
				...
				echo '<span class="button redux-background-upload" id="' . esc_attr( $this->field['id'] ) . '-media">' . esc_html__( 'Upload', 'dina-kala' ) . '</span>';
				...
				echo '<span class="button removeCSS redux-remove-background' . esc_attr( $hide ) . '" id="reset_' . esc_attr( $this->field['id'] ) . '" rel="' . esc_attr( $this->field['id'] ) . '">' . esc_html__( 'Remove', 'dina-kala' ) . '</span>';
