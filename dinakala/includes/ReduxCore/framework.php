...
if ( ! class_exists( 'ReduxFramework', false ) ) {
	...
	class ReduxFramework {
		...
		public function __clone() {
			_doing_it_wrong( __FUNCTION__, esc_html__( 'Cheatin&#8217; eh?', 'dina-kala' ), '4.0' );
		}
		...
		private function deprecated_filesystem( $filesystem ) {
			//_deprecated_function( esc_html__( 'The global variable "$filesystem" of the ReduxFramework object', 'dina-kala' ), '4.5.1', 'Redux_Core::$filesystem' );
