	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'dina-kala' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'dina-kala' ); ?></th>
			</tr>
		</thead>
		<tbody>
